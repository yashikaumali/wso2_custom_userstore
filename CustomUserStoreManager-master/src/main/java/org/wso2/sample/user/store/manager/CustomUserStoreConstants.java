...
public class CustomUserStoreConstants {
    ...
    static {
        ...
        setMandatoryProperty(JDBCRealmConstants.PASSWORD, "Connection Name", "",
        ...
        setAdvancedProperty("SelectUserSQL", "Select User SQL",
                "SELECT * FROM UM_USER WHERE UM_USER_NAME=?", "");
        setAdvancedProperty("UserFilterSQL", "User Filter SQL",
                "SELECT UM_USER_NAME FROM UM_USER WHERE UM_USER_NAME LIKE ? ORDER BY UM_USER_ID", "");
    }
